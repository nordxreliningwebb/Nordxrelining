...
@media (max-width: 768px) {
    /* Layout - MUST have at least 24px left/right to clear the 16px wide pipes */
    .calc-card {
    ...
    /* Headings */
    .view-title {
        font-size: 1.15rem !important; /* Even smaller heading */
...
console.log('Appended corrected mobile overrides');
