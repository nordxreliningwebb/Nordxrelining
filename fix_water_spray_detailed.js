...
<svg viewBox="0 0 160 800" preserveAspectRatio="xMidYMin meet" class="stamspolning-svg">
    ...
    <g class="nozzle-group" style="transform: translateY(calc(800px * var(--scroll-progress, 0)));" filter="url(#shadow-deep)">
        ...
        <g>
            <!-- Solid base hitting walls -->
            <path d="M 80 15 L 35 -60 M 80 15 L 125 -60" stroke="#bae6fd" stroke-width="16" stroke-linecap="round" fill="none" opacity="0.4" />
            
            <!-- Animated high-speed internal flow (Negative offset = moves outwards from nozzle) -->
            <path d="M 80 15 L 45 -50 M 80 15 L 115 -50" stroke="#7dd3fc" stroke-width="6" stroke-linecap="round" fill="none" opacity="0.9" stroke-dasharray="15 10" style="stroke-dashoffset: calc(-2000px * var(--scroll-progress, 0));" />
            
            <!-- Faster inner core stream -->
            <path d="M 80 15 L 55 -40 M 80 15 L 105 -40" stroke="#ffffff" stroke-width="3" stroke-linecap="round" fill="none" stroke-dasharray="25 15" style="stroke-dashoffset: calc(-3000px * var(--scroll-progress, 0));" />
        </g>

        <!-- Forward Jets (Cleaning) -->
        <g>
            <!-- 1. Solid volume cone (gives it the nice shape) -->
            <path d="M 80 40 L 35 200 Q 80 230 125 200 Z" fill="url(#water-cone)" />
            
            <!-- 2. High-speed animated streams inside the cone -->
            <!-- Outer fast streams -->
            <path d="M 80 40 L 55 180 M 80 40 L 105 180" stroke="#0ea5e9" stroke-width="6" stroke-linecap="round" fill="none" opacity="0.8" stroke-dasharray="30 15" style="stroke-dashoffset: calc(-3000px * var(--scroll-progress, 0));" />
            
            <!-- Inner faster streams -->
            <path d="M 80 40 L 65 175 M 80 40 L 95 175" stroke="#bae6fd" stroke-width="4" stroke-linecap="round" fill="none" opacity="0.9" stroke-dasharray="40 20" style="stroke-dashoffset: calc(-4500px * var(--scroll-progress, 0));" />
            
            <!-- Core solid beam (keeps it looking powerful) -->
            <path d="M 80 40 L 80 190" stroke="#ffffff" stroke-width="4" stroke-linecap="round" fill="none" />
            
            <!-- Droplets spraying inside -->
            <path d="M 80 40 L 45 180 M 80 40 L 115 180" stroke="#ffffff" stroke-width="2" stroke-linecap="round" fill="none" opacity="0.8" stroke-dasharray="4 20" style="stroke-dashoffset: calc(-5500px * var(--scroll-progress, 0));" />
        </g>
...
if(oldSvgRegex.test(content)) {
    ...
    console.log('Stamspolning SVG updated to detailed spraying water');
} else {
