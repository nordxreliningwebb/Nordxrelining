...
// Replace everything between <style dangerouslySetInnerHTML={{__html: ` and `}} />
content = content.replace(/<style dangerouslySetInnerHTML=\{\{__html: `[\s\S]*?`\}\} \/>/, styleBlock.trim());

fs.writeFileSync(file, content);
console.log("Injected updated style block into KalkylatorPage");
