...
<svg viewBox="0 0 160 800" preserveAspectRatio="xMidYMin meet" class="stamspolning-svg">
    ...
    <g class="nozzle-group" style="transform: translateY(calc(800px * var(--scroll-progress, 0)));" filter="url(#shadow-deep)">
        ...
        <!-- Backward Jets (Propulsion) - CONSTRAINED INSIDE THE PIPE (X: 30 to 130) -->
        <g>
            <path d="M 80 15 L 35 -60 M 80 15 L 125 -60" stroke="#bae6fd" stroke-width="16" stroke-linecap="round" fill="none" opacity="0.6" />
            <path d="M 80 15 L 45 -50 M 80 15 L 115 -50" stroke="#7dd3fc" stroke-width="6" stroke-linecap="round" fill="none" opacity="0.9" />
            <path d="M 80 15 L 55 -40 M 80 15 L 105 -40" stroke="#ffffff" stroke-width="3" stroke-linecap="round" fill="none" />
        </g>

        <!-- Forward Jets (Cleaning) - STATIC & CONSTAINED -->
        <g>
...
if(oldSvgRegex.test(content)) {
    ...
    console.log('Stamspolning SVG updated to constrained static water');
} else {
