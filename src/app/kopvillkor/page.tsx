...
export const metadata: Metadata = {
  title: 'Köpvillkor | Nordxrelining',
  description: 'Allmänna villkor för tjänster och uppdrag utförda av Nordxrelining.',
};
        ...
        <section className="legal-page-wrapper" style={{ padding: "80px 20px", backgroundColor: "#ffffff" }}>
            <div className="legal-container" style={{ maxWidth: "800px", margin: "0 auto", color: "#334155", fontSize: "1.125rem", lineHeight: "1.8" }}>
                <p className="anim-fade-up" style={{ marginBottom: "2rem" }}>
                    Dessa allmänna villkor gäller för alla tjänster och uppdrag som utförs av Nordxrelining (hädanefter "Nordxrelining", "vi" eller "oss") gentemot dig som kund ("Kunden"), såvida inget annat skriftligen avtalats.
                </p>
                ...
                <p className="anim-fade-up" style={{ marginBottom: "1.5rem" }}>
                    Nordxrelining erbjuder tjänster inom stamspolning, relining och rörinspektion för fastigheter, bostadsrättsföreningar och privatpersoner, enligt specifikation i offert eller avtal mellan båda parter.
                </p>
                ...
                <p className="anim-fade-up" style={{ marginBottom: "1.5rem" }}>
                    Alla rättigheter till framtagen dokumentation, rörinspektionsfilmer, protokoll och garantibevis tillhör Nordxrelining till dess att full betalning har erlagts. Därefter erhåller Kunden full äganderätt och rätt att nyttja handlingarna för den specifika fastigheten.
                </p>
