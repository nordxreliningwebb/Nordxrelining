document.addEventListener('DOMContentLoaded', () => {
    ...
    const blogFilterBtns = document.querySelectorAll('.blog-filter-nav-v2 button, .blog-filter-nav button, .nordx-filter-btn');
        ...
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    // Hantera 'Tillbaka'-knappen (obsolete)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const allFilterBtns = document.querySelectorAll('.filter-btn, .blog-filter-nav-v2 button, .blog-filter-nav button, .nordx-filter-btn');
